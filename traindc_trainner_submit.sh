...
singularity exec  --nv  --writable ~/singularity/pt-cuda-tf-tr-ft python ~/ner-data-selection/train_nermodels.py --dc_save_root ${dc_save_folder} --save_folder_root ${ner_save_folder} --save_folder ${ner_save_folder} --dataset_root ${ner_dataset_root}  --evaluate_root ${ner_dataset_root} --load_dc_model  --multiple --dev_only
