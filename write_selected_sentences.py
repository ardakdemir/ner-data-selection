...
selected_sentences = {
    "bioBERT": {"BC2GM": [("BC4CHEMD", [1, 2, 3], ['I', 'am', 'the', 'first', 'Menieres', 'Disease'],
                           ['O', 'O', 'O', 'O', 'B-Entity', 'I-Entity']),
                          ("BC4CHEMD", [1, 2, 3], ['I', 'am', 'the', 'second', 'CANCER', 'DISEASE'],
                           ['O', 'O', 'O', 'O', 'B-Entity', 'I-Entity'])],
                "BC4CHEMD": [("BC4CHEMD", [1, 2, 3], ['I', 'am', 'the', 'first', 'Chemical', 'sentence'],
                              ['O', 'O', 'O', 'O', 'B-Entity', "O"]),
                             ("linnaeus", [1, 2, 3], ['I', 'am', 'the', 'second', 's800', 'sentence'],
                              ['O', 'O', 'O', 'O', 'O', "O"]),
                             ("s800", [1, 2, 3], ['I', 'am', 'the', 'third', 's800', 'sentence'],
                              ['O', 'O', 'O', 'O', 'B-Entity', "O"])]},
    "bioWordVec": {"linnaeus": [("a", [1, 2, 3], ['I', 'am', 'the', 'first', 'linnaeus', 'sentence'],
                                 ['O', 'O', 'O', 'O', 'O', "O"]),
                                ("a", [1, 2, 3], ['I', 'am', 'the', 'second', 'biowordVec', 'sentence'],
                                 ['O', 'O', 'O', 'O', 'B-Entity', "O"])]}}
